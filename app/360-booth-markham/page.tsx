...
const pageData: ServiceLocationData = {
  ...
  description: 'Markham\'s tech-forward community appreciates cutting-edge entertainment, making our 360 video booth a perfect fit for events at Paradise Banquet Hall, Le Parc, and modern venues throughout Unionville and Cornell. The rotating camera technology creates smooth, cinematic slow-motion videos that Markham\'s social media-savvy crowd immediately shares across Instagram, TikTok, and WeChat. From fusion weddings where East meets West in spectacular fashion, to corporate tech launches where innovation matters, the 360 booth delivers content worthy of Markham\'s high standards. Our advanced setup includes 4K video capture, professional color grading that looks stunning on all platforms, customizable digital overlays in multiple languages, and instant delivery via any messaging platform your guests prefer. The result? Shareable moments that showcase Markham\'s unique blend of tradition and technology in every spinning second.',
  ...
  faqs: [
    ...
    },
    {
      ...
      answer: 'We recommend a space of approximately 12ft x 12ft for optimal setup and guest safety. The platform itself is compact, but we need clearance for the camera arm rotation and space for guests to queue. Our team will work with you to find the perfect spot at your Markham venue.',
    },
    {
      question: 'Is the 360 booth safe?',
      answer: 'Absolutely! Safety is our top priority. Our premium platform features a non-slip surface, is extremely sturdy, and can safely hold multiple people. Our professional attendant is on site to guide guests, ensure proper use, and maintain safety throughout your Markham event.',
    },
    {
      question: 'Can we customize the videos with overlays or branding?',
      answer: 'Yes! We can add custom overlays, logos, event hashtags, and branding to the 360 videos. This is perfect for corporate events, brand activations, and weddings where you want personalized content. Share your vision and we\'ll create custom video overlays for your Markham event.',
    },
    {
      question: 'Will the 360 booth work at outdoor Markham venues?',
      answer: 'The 360 video booth can work outdoors under certain conditions - it needs to be covered (tent or overhang) and on flat, stable ground. Weather conditions and lighting must be suitable. We regularly set up at both indoor and covered outdoor venues across Markham. Contact us to discuss your specific venue.',
    },
  ],
  relatedServices: [
    {
