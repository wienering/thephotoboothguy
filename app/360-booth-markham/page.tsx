...
export const metadata: Metadata = {
  title: '360 Video Booth Markham | The Photobooth Guy',
  description: '360 video booth rental in Markham. Professional camera arm, instant video delivery. Weddings, corporate events, parties. Book your GTA event.',
  ...
  alternates: {
    canonical: 'https://www.thephotoboothguy.ca/360-booth-markham',
  },
  openGraph: { url: 'https://www.thephotoboothguy.ca/360-booth-markham' },
};
