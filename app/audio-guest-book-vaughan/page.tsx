...
export const metadata: Metadata = {
  ...
  description: 'Audio guest book rental in Vaughan. Vintage telephone for wedding voice messages. Professional service.',
