...
const pageData: ServiceLocationData = {
  ...
  description: 'Take your Mississauga event to the next level with our professional 360 video booth. Guests step onto a premium platform while our high-speed camera rotates around them, capturing stunning slow-motion video from every angle. Perfect for weddings, corporate events, product launches, and parties across Mississauga. Each package includes a professional camera arm, trained attendant on site, instant video delivery to guests via text or email, professional lighting, premium platform with safety features, props, and a complete digital gallery after your event.',
