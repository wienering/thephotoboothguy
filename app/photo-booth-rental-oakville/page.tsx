...
export const metadata: Metadata = {
  ...
  description:
    "Photo booth rental in Oakville. DSLR cameras, instant prints, custom templates. Weddings, corporate events, parties. Serving the GTA.",
  keywords:
    "photo booth rental Oakville, Oakville photo booth, photo booth hire Oakville, wedding photo booth Oakville, corporate photo booth Oakville, instant prints, DSLR camera, professional attendant",
  alternates: {
    canonical: "https://www.thephotoboothguy.ca/photo-booth-rental-oakville",
  },
  openGraph: {
    url: "https://www.thephotoboothguy.ca/photo-booth-rental-oakville",
  },
};
...
const pageData: ServiceLocationData = {
  ...
  heroSubtitle:
    "Professional photo booth services with instant prints, custom templates, stunning backdrops, and props for weddings, corporate events, and parties across Oakville.",
  description:
  ...
  faqs: [
    {
      ...
      answer:
        "Photo booth rental in Oakville starts at $550 for our Essential package, which includes 2 hours of service with a professional attendant, instant prints, custom templates, backdrop selection, props, and digital delivery. Our Signature package is $750 for 3 hours, and our Premium package is $950 for 4 hours. All packages include the same high-quality equipment and service - you're just choosing how long you need the photo booth at your Oakville event.",
    },
    {
      question: "What areas of Oakville do you serve for photo booth rentals?",
      answer:
        "We provide photo booth rental services throughout all areas of Oakville including the downtown core, Bronte, Kerr Village, and surrounding neighborhoods. We regularly serve venues like Oakville Conference Centre, Oakville Centre for the Performing Arts, Glen Abbey Golf Club, and many others across the city. If you're planning an event anywhere in Oakville, we can help.",
    },
    {
    ...
    {
      question:
        "Can I customize the photo booth print template for my Oakville wedding?",
      answer:
        "Absolutely! We design custom print templates at no additional charge for all Oakville events. Just share your wedding colors, theme, logos, or any design elements you want, and we'll create templates that perfectly match your Oakville wedding. Many couples include their names, wedding date, or a special message on the templates.",
    },
    {
      question:
        "What type of camera do you use for photo booth rentals in Oakville?",
      answer:
    ...
    {
      question:
        "Do you provide a photo booth attendant for events in Oakville?",
      answer:
        "Yes! Every photo booth rental in Oakville includes a professional attendant who stays on site for the entire duration of your event. They handle setup, assist guests, troubleshoot any issues, and make sure everything runs smoothly so you can enjoy your celebration without worrying about the photo booth.",
    },
    {
      question:
        "What backdrop options are available for photo booth rentals in Oakville?",
      answer:
