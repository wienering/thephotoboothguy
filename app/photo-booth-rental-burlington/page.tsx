...
const pageData: ServiceLocationData = {
  ...
  faqs: [
    {
      question: 'Do you serve all areas of Burlington?',
      answer: 'Yes! We provide photo booth rental services throughout Burlington including the downtown core, Aldershot, Alton Village, and all surrounding neighborhoods. We regularly serve venues like Burlington Convention Centre, Royal Botanical Gardens, Burlington Performing Arts Centre, and many others across the city.',
    },
    {
    ...
    },
    {
      ...
      answer: 'Absolutely! We design custom print templates at no additional charge. Share your event colors, theme, logos, or any design elements you want, and we\'ll create templates that perfectly match your Burlington event.',
    },
    {
      question: 'What backdrop options are available?',
      answer: 'We offer a variety of backdrop options from elegant solid colors to sequined backdrops, florals, and custom designs. View our backdrops page or contact us to discuss options for your Burlington event.',
    },
  ],
  relatedServices: [
    {
...
export default function PhotoBoothRentalBurlington() {
  return (
    <>
      <SchemaMarkup
