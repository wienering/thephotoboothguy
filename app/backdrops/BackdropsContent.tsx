...
export default function BackdropsContent() {
  ...
  const { heroImage } = useMemo(() => getImagesForPage('backdrops'), []);
  ...
  return (
    <div className="min-h-screen pt-20">
      ...
      >
        {heroImage && (
          <>
            <Image src={heroImage.src} alt={heroImage.alt ?? 'Photo booth backdrop'} fill className="object-cover object-center" sizes="100vw" priority />
