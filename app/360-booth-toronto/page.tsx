...
export const metadata: Metadata = {
  title: '360 Video Booth Toronto | The Photobooth Guy',
  description: '360 video booth rental in Toronto. Professional camera arm, instant video delivery. Weddings, corporate events, parties. Book your GTA event.',
  ...
  alternates: {
    canonical: 'https://www.thephotoboothguy.ca/360-booth-toronto',
  },
  openGraph: { url: 'https://www.thephotoboothguy.ca/360-booth-toronto' },
};
...
const pageData: ServiceLocationData = {
  ...
  faqs: [
    {
      question: 'How much does a 360 video booth cost in Toronto?',
      answer: '360 video booth rental in Toronto starts at $550 for our Essential package (2 hours), $750 for Signature (3 hours), and $950 for Premium (4 hours). All packages include the professional 360 video booth with camera arm, premium platform, professional lighting, instant video delivery, props, and a professional attendant. It\'s the most unique and shareable entertainment option for Toronto events.',
    },
    {
      question: 'How does the 360 video booth work at a Toronto event?',
    ...
    {
      question: 'How much space do I need for a 360 booth at my Toronto venue?',
      answer: 'We recommend a space of approximately 12ft x 12ft for optimal setup and guest safety. The platform itself is compact, but we need clearance for the camera arm rotation and space for guests to queue. Our team will work with you to find the perfect spot at your Toronto venue - we\'ve set up at many venues across the city and can usually make it work.',
    },
    {
      question: 'Is the 360 video booth safe for guests in Toronto?',
      answer: 'Absolutely! Safety is our top priority. Our premium platform features a non-slip surface, is extremely sturdy, and can safely hold multiple people. Our professional attendant is on site to guide guests, ensure proper use, and maintain safety throughout your Toronto event. We\'ve never had a safety incident and take every precaution.',
    },
    {
      question: 'Can I customize the 360 booth videos with my wedding hashtag or logo in Toronto?',
      answer: 'Yes! We can add custom overlays, logos, event hashtags, and branding to the 360 videos. This is perfect for corporate events, brand activations, and weddings where you want personalized content. Share your vision and we\'ll create custom video overlays for your Toronto event. Many couples add their wedding hashtag or names to make the videos even more special.',
    },
    {
      question: 'Can I use a 360 booth at an outdoor venue in Toronto?',
      answer: 'The 360 video booth can work outdoors under certain conditions - it needs to be covered (tent or overhang) and on flat, stable ground. Weather conditions and lighting must be suitable. We regularly set up at both indoor and covered outdoor venues across Toronto. Contact us to discuss your specific venue and we can determine if it will work.',
    },
    {
      question: 'How quickly do guests receive their 360 videos at Toronto events?',
      answer: 'Videos are processed immediately and sent to guests via text message or email within seconds of being recorded. They can share on social media right away, which makes the 360 booth perfect for Toronto\'s social media-savvy crowd. The instant delivery is one of the most popular features of our 360 booth service.',
    },
  ],
  relatedServices: [
    {
