...
const pageData: ServiceLocationData = {
  ...
  heroSubtitle:
    "Professional photo booth services with instant prints, custom templates, stunning backdrops, and props for weddings, corporate events, and parties across Markham.",
  description:
  ...
  faqs: [
    {
      ...
      answer:
        "Photo booth rental in Markham starts at $550 for our Essential package, which includes 2 hours of service with a professional attendant, instant prints, custom templates, backdrop selection, props, and digital delivery. Our Signature package is $750 for 3 hours, and our Premium package is $950 for 4 hours. All packages include the same high-quality equipment and service - you're just choosing how long you need the photo booth at your Markham event.",
    },
    {
      question: "What areas of Markham do you serve for photo booth rentals?",
      answer:
        "We provide photo booth rental services throughout all areas of Markham including Unionville, Thornhill, Milliken, Berczy Village, and surrounding neighborhoods. We regularly serve venues like Paradise Banquet Hall Markham, Le Parc Banquet Hall, Cedar Valley Event Centre, and many others across the city. If you're planning an event anywhere in Markham, we can help.",
    },
    {
    ...
    {
      question:
        "Can I customize the photo booth print template for my Markham wedding?",
      answer:
        "Absolutely! We design custom print templates at no additional charge for all Markham events. Just share your wedding colors, theme, logos, or any design elements you want, and we'll create templates that perfectly match your Markham wedding. Many couples include their names, wedding date, or a special message on the templates.",
    },
    {
      question:
        "What type of camera do you use for photo booth rentals in Markham?",
      answer:
    ...
    },
    {
      ...
      answer:
        "Yes! Every photo booth rental in Markham includes a professional attendant who stays on site for the entire duration of your event. They handle setup, assist guests, troubleshoot any issues, and make sure everything runs smoothly so you can enjoy your celebration without worrying about the photo booth.",
    },
    {
      question:
        "What backdrop options are available for photo booth rentals in Markham?",
      answer:
