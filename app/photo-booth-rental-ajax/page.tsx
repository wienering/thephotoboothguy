...
export const metadata: Metadata = {
  ...
  keywords:
    "photo booth rental Ajax, Ajax photo booth, photo booth hire Ajax, wedding photo booth Ajax, corporate photo booth Ajax, instant prints, DSLR camera, professional attendant",
  alternates: {
