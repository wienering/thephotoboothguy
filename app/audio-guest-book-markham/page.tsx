...
export const metadata: Metadata = {
  title: 'Audio Guest Book Markham | The Photobooth Guy',
  description: 'Audio guest book rental in Markham. Vintage telephone captures voice messages at weddings. Professional service across the GTA.',
  ...
  alternates: {
    canonical: 'https://www.thephotoboothguy.ca/audio-guest-book-markham',
  },
  openGraph: { url: 'https://www.thephotoboothguy.ca/audio-guest-book-markham' },
};
