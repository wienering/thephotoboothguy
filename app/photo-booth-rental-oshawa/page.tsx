...
export const metadata: Metadata = {
  ...
  description:
    "Photo booth rental in Oshawa. DSLR cameras, instant prints, custom templates. Weddings, corporate events, parties. Serving the GTA.",
  keywords:
    "photo booth rental Oshawa, Oshawa photo booth, photo booth hire Oshawa, wedding photo booth Oshawa, corporate photo booth Oshawa, instant prints, DSLR camera, professional attendant",
  alternates: {
    canonical: "https://www.thephotoboothguy.ca/photo-booth-rental-oshawa",
  },
  openGraph: {
    url: "https://www.thephotoboothguy.ca/photo-booth-rental-oshawa",
  },
};
  ...
  faqs: [
    {
      ...
      answer:
        "Photo booth rental in Oshawa starts at $550 for our Essential package, which includes 2 hours of service with a professional attendant, instant prints, custom templates, backdrop selection, props, and digital delivery. Our Signature package is $750 for 3 hours, and our Premium package is $950 for 4 hours. All packages include the same high-quality equipment and service - you're just choosing how long you need the photo booth at your Oshawa event.",
    },
    {
      question: "What areas of Oshawa do you serve for photo booth rentals?",
      answer:
        "We provide photo booth rental services throughout all areas of Oshawa including the downtown core, North Oshawa, South Oshawa, and surrounding neighborhoods. We regularly serve venues like Oshawa Convention Centre, Regent Theatre, Oshawa Golf & Curling Club, and many others across the city. If you're planning an event anywhere in Oshawa, we can help.",
    },
    {
    ...
    {
      question:
        "Can I customize the photo booth print template for my Oshawa wedding?",
      answer:
        "Absolutely! We design custom print templates at no additional charge for all Oshawa events. Just share your wedding colors, theme, logos, or any design elements you want, and we'll create templates that perfectly match your Oshawa wedding. Many couples include their names, wedding date, or a special message on the templates.",
    },
    {
      question:
        "What type of camera do you use for photo booth rentals in Oshawa?",
      answer:
    ...
    },
    {
      ...
      answer:
        "Yes! Every photo booth rental in Oshawa includes a professional attendant who stays on site for the entire duration of your event. They handle setup, assist guests, troubleshoot any issues, and make sure everything runs smoothly so you can enjoy your celebration without worrying about the photo booth.",
    },
    {
      question:
        "What backdrop options are available for photo booth rentals in Oshawa?",
      answer:
