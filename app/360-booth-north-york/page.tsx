...
export const metadata: Metadata = {
  ...
  description: '360 video booth rental in North York. Professional camera arm, instant video delivery. Weddings, corporate events, parties. Book your GTA event.',
  ...
  openGraph: { url: 'https://www.thephotoboothguy.ca/360-booth-north-york' },
};
