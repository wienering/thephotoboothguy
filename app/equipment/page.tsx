...
export const metadata: Metadata = definePageMetadata({
  ...
  description: "What we bring: professional DSLR booths, dye-sublimation printers, studio-style lighting, and touchscreens—servicing Toronto & GTA weddings, corporate, and parties.",
  ...
  canonicalUrl: 'https://www.thephotoboothguy.ca/equipment',
});
