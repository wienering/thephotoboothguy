...
export const metadata: Metadata = {
  ...
  description: 'Audio guest book rental in Burlington. Vintage telephone captures voice messages at weddings. Professional service across the GTA.',
  ...
  openGraph: { url: 'https://www.thephotoboothguy.ca/audio-guest-book-burlington' },
};
