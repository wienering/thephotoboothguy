...
const pageData: ServiceLocationData = {
  ...
  city: 'Pickering',
  heroTitle: '360 Video Booth in Pickering',
  heroSubtitle: 'Create stunning slow-motion 360-degree videos at your Pickering event. Professional camera arm, instant video delivery, and unforgettable entertainment for weddings, corporate events, and parties.',
  description: 'Pickering\'s modern, growing community embraces innovative entertainment, making our 360 video booth the perfect addition to events at Pickering Recreation Complex, Pickering Convention Centre, and venues throughout the city. The rotating camera captures guests from every angle in stunning slow-motion, creating shareable content that becomes the highlight of your Pickering event. Whether you\'re hosting a wedding where families want to capture multi-generational moments, a corporate function, or a milestone celebration, our 360 booth delivers viral-worthy content that guests can\'t wait to share. The premium platform safely accommodates groups up to 4 people, professional lighting ensures gallery-quality results regardless of venue lighting, and videos are processed and sent to guests\' phones within seconds. Perfect for Pickering\'s social media-savvy crowd who want instant, shareable content that stands out.',
  ...
  features: [
    ...
    },
    {
      ...
      description: 'Fun props and accessories provided to help guests create entertaining, creative 360 videos at your Pickering event.',
    },
  ],
  ...
  faqs: [
    ...
    {
      question: 'How much space do I need for a 360 booth at my Pickering venue?',
      answer: 'We recommend a space of approximately 12ft x 12ft for optimal setup and guest safety. The platform itself is compact, but we need clearance for the camera arm rotation and space for guests to queue. Our team will work with you to find the perfect spot at your Pickering venue - we\'ve set up at many venues across the city and can usually make it work.',
    },
    {
      question: 'Is the 360 video booth safe for guests in Pickering?',
      answer: 'Absolutely! Safety is our top priority. Our premium platform features a non-slip surface, is extremely sturdy, and can safely hold multiple people. Our professional attendant is on site to guide guests, ensure proper use, and maintain safety throughout your Pickering event. We\'ve never had a safety incident and take every precaution.',
    },
    {
      question: 'Can I customize the 360 booth videos with my wedding hashtag or logo in Pickering?',
      answer: 'Yes! We can add custom overlays, logos, event hashtags, and branding to the 360 videos. This is perfect for corporate events, brand activations, and weddings where you want personalized content. Share your vision and we\'ll create custom video overlays for your Pickering event. Many couples add their wedding hashtag or names to make the videos even more special.',
    },
    {
      question: 'Can I use a 360 booth at an outdoor venue in Pickering?',
      answer: 'The 360 video booth can work outdoors under certain conditions - it needs to be covered (tent or overhang) and on flat, stable ground. Weather conditions and lighting must be suitable. We regularly set up at both indoor and covered outdoor venues across Pickering. Contact us to discuss your specific venue and we can determine if it will work.',
    },
    {
      question: 'How quickly do guests receive their 360 videos at Pickering events?',
      answer: 'Videos are processed immediately and sent to guests via text message or email within seconds of being recorded. They can share on social media right away, which makes the 360 booth perfect for Pickering\'s social media-savvy crowd. The instant delivery is one of the most popular features of our 360 booth service.',
    },
  ],
  relatedServices: [
    {
...
export default function Booth360Pickering() {
  return (
    <>
      <SchemaMarkup
