...
const pageData: ServiceLocationData = {
  ...
  faqs: [
    ...
    {
      question: 'Is the glam booth suitable for outdoor Oakville events?',
      answer: 'The glam booth works best indoors where we can control the lighting environment for optimal results. We regularly set up at Oakville venues like Oakville Conference Centre, Glen Abbey Golf Club, and other premium indoor locations where we can achieve the perfect lighting conditions.',
    },
    {
    ...
    },
    {
      ...
      answer: 'The glam booth is ideal for weddings, corporate galas, milestone celebrations, anniversary parties, and any upscale Oakville event where you want to create a sophisticated, glamorous atmosphere. It\'s particularly popular at high-end venues throughout Oakville.',
    },
  ],
  relatedServices: [
    {
