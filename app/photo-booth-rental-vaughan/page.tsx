...
export const metadata: Metadata = {
  ...
  description:
    "Photo booth rental in Vaughan. DSLR cameras, instant prints, custom templates. Weddings, corporate events, parties. Serving the GTA.",
  keywords:
    "photo booth rental Vaughan, Vaughan photo booth, photo booth hire Vaughan, wedding photo booth Vaughan, corporate photo booth Vaughan, instant prints, professional attendant",
  alternates: {
    canonical: "https://www.thephotoboothguy.ca/photo-booth-rental-vaughan",
  },
  openGraph: {
    url: "https://www.thephotoboothguy.ca/photo-booth-rental-vaughan",
  },
};
  ...
  faqs: [
    {
      ...
      answer:
        "Photo booth rental in Vaughan starts at $550 for our Essential package, which includes 2 hours of service with a professional attendant, instant prints, custom templates, backdrop selection, props, and digital delivery. Our Signature package is $750 for 3 hours, and our Premium package is $950 for 4 hours. All packages include the same high-quality equipment and service - you're just choosing how long you need the photo booth at your Vaughan event.",
    },
    {
      question: "What areas of Vaughan do you serve for photo booth rentals?",
      answer:
        "We provide photo booth rental services throughout all areas of Vaughan including Woodbridge, Concord, Thornhill, Maple, and surrounding neighborhoods. We regularly serve venues like Paradise Banquet & Convention Centre, The Manor by Peter & Paul's, Venetian Banquet Hall, and many others across the city. If you're planning an event anywhere in Vaughan, we can help.",
    },
    {
    ...
    {
      question:
        "Can I customize the photo booth print template for my Vaughan wedding?",
      answer:
        "Absolutely! We design custom print templates at no additional charge for all Vaughan events. Just share your wedding colors, theme, logos, or any design elements you want, and we'll create templates that perfectly match your Vaughan wedding. Many couples include their names, wedding date, or a special message on the templates.",
    },
    {
      question:
        "What type of camera do you use for photo booth rentals in Vaughan?",
      answer:
    ...
    },
    {
      ...
      answer:
        "Yes! Every photo booth rental in Vaughan includes a professional attendant who stays on site for the entire duration of your event. They handle setup, assist guests, troubleshoot any issues, and make sure everything runs smoothly so you can enjoy your celebration without worrying about the photo booth.",
    },
    {
      question:
        "What backdrop options are available for photo booth rentals in Vaughan?",
      answer:
